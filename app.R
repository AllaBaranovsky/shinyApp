...
setwd("/Users/allabaranovsky/Desktop/projects/shiny/MyApp")
...
# Define the ui
ui <- navbarPage("Police brutality against POC, US, 2013 - 2019",
                 tabPanel(
                   "Map Quantiles",
                   sidebarLayout(
                     sidebarPanel(
            ...
            3rd quartile = 58 police murders"
                 ...
                 tabPanel(
                   ...
                   sidebarLayout(
                     ...
                     mainPanel(
                       # Add the dynamic_plot UI. Plot all the 4 plots here depending on the input$characteristics
...
server <- function(input, output, session) {
  output$map_plot <- renderPlotly({
    ...
    # Filterthe plot data based on the input the user selects
  ...
  # This is to run R code whenever the particular input element (input$characteristics in this case) is changed
  observeEvent(input$characteristics, {
    # Based on the input provided by the user, this changes the dynamic_plot_object to the plotly object
    ...
    # Render the updated dynamic_plot_object to the UI
